...
public class MediaProvider {
	...
	public synchronized BufferedImage createImage(int width, int height, boolean translucent) {
		BufferedImage img = config.createCompatibleImage(width, height,
				translucent ? Transparency.TRANSLUCENT : Transparency.OPAQUE);
		return img;
	}
	...
	/**
	 * Loads an image from in-jar resource, relative to com/zarkonnen/play/SEGame/images.
	...
	*/
	...
	public synchronized BufferedImage readImage(String name) {
		String extName = name;
